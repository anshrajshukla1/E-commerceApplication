...
import sb.ecom.ecommerce.service.ProductService;
...
ProductService productService;
   ...
   public ResponseEntity<ProductResponse> getProductsByCategory(@PathVariable Long categoryId,
    ...
    public ResponseEntity<ProductDTO> updateProductsForSeller(@RequestBody ProductDTO productDTO,
    ...
    public ResponseEntity<ProductDTO> deleteProductsForSeller(@PathVariable Long productId) {
        ProductDTO deletedProductDTO = productService.deleteProduct(productId);
        return new ResponseEntity<>(deletedProductDTO, HttpStatus.OK);
    }
