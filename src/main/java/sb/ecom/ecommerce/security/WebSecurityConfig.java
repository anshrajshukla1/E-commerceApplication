package sb.ecom.ecommerce.security;
...
import sb.ecom.ecommerce.security.jwt.AuthEntryPointJwt;
import sb.ecom.ecommerce.security.jwt.AuthTokenFilter;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                .cors(cors -> {}) // ✅ FIXED (no deprecated warning)
